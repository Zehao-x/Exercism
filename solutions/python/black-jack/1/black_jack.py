...
def higher_card(card_one, card_two):
    ...
    val_1, val_2 = value_of_card(card_one), value_of_card(card_two)
    if val_1 < val_2:
        return card_two
    elif val_1 > val_2:
        return card_one
...
def value_of_ace(card_one, card_two):
    ...
    def value_of_card_1(card):
        if card in ("J", "Q", "K"):
            ...
            return int(card)
    val_1, val_2 = value_of_card_1(card_one), value_of_card_1(card_two)
...
def is_blackjack(card_one, card_two):
    ...
    if (card_one in ("10", "J", "Q", "K") and card_two == "A") or (card_two in ("10", "J", "Q", "K") and card_one == "A"):
        return True
    else:
        return False
