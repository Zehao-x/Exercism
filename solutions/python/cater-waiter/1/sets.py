...
def check_drinks(drink_name, drink_ingredients):
    ...
    for ingre in drink_ingredients:
        if ingre in ALCOHOLS:
...
def tag_special_ingredients(dish):
    ...
    """
    return (dish[0], set(ingre for ingre in dish[1] if ingre in SPECIAL_INGREDIENTS))
...
if __name__ == '__main__':
    res = tag_special_ingredients(('Ginger Glazed Tofu Cutlets', ['tofu', 'soy sauce', 'ginger', 'corn starch', 'garlic', 'brown sugar', 'sesame seeds', 'lemon juice']))
    print(res)
